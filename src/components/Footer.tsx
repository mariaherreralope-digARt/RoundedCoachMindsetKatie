...
const Footer: FC = () => {
  return (
    <footer className="bg-light">
      <div className="mx-auto px-16 lg:px-16 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-12">
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-lighter rounded-full flex items-center justify-center text-gray-600 hover:bg-btt hover:text-dark transition-all duration-200"
              >
          ...
          <div className="lg:col-span-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {Object.entries(footerLinks).map(([category, links]) => (
                <div key={category}>
                  <h3 className="oversection text-dark mb-4">
                    {category}
                  </h3>
                  <ul className="space-y-2">
                    {links.map((link, index) => (
                      <li key={index}>
                        <a
                          href={link.href}
                          className="text-dark  hover:text-lighter paragraph transition-colors duration-200"
                        >
                          {link.name}
                        </a>
                      </li>
