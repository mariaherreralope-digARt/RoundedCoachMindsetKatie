...
<div className="relative grid md:grid-cols-2 gap-10 py-4">
  ...
  />
    <div className="absolute bg-lighter py-4 px-6 flex flex-col items-center self-end -mb-8">
      <h3 className="text-md font-serif italic mb-2 text-darker">Exploring the Mountains</h3>
      <button className=" bg-dark py-2 px-4 uppercase text-xs text-light ">Learn More</button>
    </div>
  </div>
   <div className="relative flex items-center justify-center">
    <Image
