...
export default function TextRoundBoxBtn() {
  ...
  <section className="relative bg-lighter py-24 flex justify-center items-center h-[70vh] overflow-hidden pb-16">
      <motion.div
        className="relative z-10 bg-light text-darker text-center px-10 py-8 max-w-xl h-auto flex flex-col items-center justify-center rounded-tr-[16rem] rounded-tl-[16rem]"
      ...
      >
        ...
        <h2 className="heading text-darker md:text-xl  max-w-[20vw] mb-6">
